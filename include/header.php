<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="top-contact float-right">
								...
								<li><i class="fas fa-user text-light  mr-1"></i>
								...
								| </li>
								<li><i class="fas fa-user-plus text-light  mr-1"></i><a href="register.php"> Register</li><?php } ?>
								</ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="main-nav secondary-nav hover-success-nav py-2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="https://i.ibb.co/NL6RBsJ/Black-Monoline-Real-Estate-Logo-2.png" alt=""></a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
									...
									<a class="btn btn-success d-none d-xl-block" style="border-radius:5px;" href="submitproperty.php">Add Property</a> 
                                </div>
                            </nav>
                        </div>
                    </div>
